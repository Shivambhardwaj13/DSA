...
//			'%-15s' means the string s1 will be left-justified within a field of 15 characters.
//			'%03d' means the integer x will be printed with at least 3 digits, padded with leading zeros if necessary.
